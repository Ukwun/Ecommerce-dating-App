...
export default function SellerLayout() {
  ...
  return (
    <Stack screenOptions={{ headerShown: true, headerStyle: { backgroundColor: theme.colors.primary }, headerTintColor: '#fff', headerTitleStyle: { fontWeight: 'bold' }, contentStyle: { backgroundColor: theme.colors.background } }}>
      <Stack.Screen name="dashboard" options={{ title: 'Seller Dashboard', headerRight: () => <TouchableOpacity onPress={() => router.push('/(seller)/profile')} style={{ marginRight: 15 }}><Text style={{ color: '#fff', fontWeight: '600' }}>Settings</Text></TouchableOpacity> }} />
