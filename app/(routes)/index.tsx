...
export default function Onboardingscreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: '#f5f5f5' }]}> 
      {/* Diagnostic log message to confirm render */}
      <Text style={{ color: 'blue', textAlign: 'center', marginTop: 10, fontWeight: 'bold', fontSize: 18 }}>
        Onboarding screen component rendered
      </Text>
      {/* Fallback text if image fails */}
      <Text style={{ color: 'red', textAlign: 'center', marginTop: 40 }}>If you see this, the onboarding image failed to load.</Text>
      <Image 
